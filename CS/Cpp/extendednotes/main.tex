...
\end{itemize}
   ...
   \bigbreak \noindent 
    ...
    \pagebreak 
    \subsection{Using std::ref with bind}
    \bigbreak \noindent 
...
void foo(myclass<T>& obj) {
    ...
    \end{cppcode}
     ...
     \bigbreak \noindent 
     \subsection{Calling a regular function}
     \bigbreak \noindent 
     \begin{cppcode}
         int add(int a, int b) {
             return a + b;
     ...
     \bigbreak \noindent 
     \subsection{Calling a member function}
     \bigbreak \noindent 
     \begin{cppcode}
         struct MyClass {
     ...
     \end{cppcode}
     \pagebreak \bigbreak \noindent 
     \subsection{Accessing a member variable}
     \bigbreak \noindent 
     \begin{cppcode}
         struct MyClass {
             int value;
