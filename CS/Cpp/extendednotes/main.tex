...
\end{itemize}
    ...
    \end{cppcode}
    \bigbreak \noindent 
    The reason your code works when using template parameters is that the template parameters r and c are compile-time constants. In C++, when you use template parameters like this, the values of r and c are determined at compile time, allowing the array sizes to be known by the compiler ahead of time
...
\end{itemize}
   ...
   \pagebreak 
   \subsection{STL Function Objects}
   \bigbreak \noindent 
