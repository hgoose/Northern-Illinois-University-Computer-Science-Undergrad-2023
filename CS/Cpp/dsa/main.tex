...
unsigned precedence(const char& op) {
    ...
    */
    ...
    \pagebreak 
    \unsect{Deque (Double ended queue)}
    \bigbreak \noindent 
...
\end{cppcode}
    ...
    \pagebreak 
    \unsect{Doubly-linked list (as a deque)}
    \bigbreak \noindent 
...
bool hash_table::erase(int key)
{
    ...
    \pagebreak 
    \unsect{Sorted Singly-linked list: Insert, remove, remove all}
    \bigbreak \noindent 
    \begin{cppcode}
