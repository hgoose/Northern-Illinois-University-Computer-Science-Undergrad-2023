...
\pagebreak 
    ...
    \begin{itemize}
        ...
        \item \textbf{How it works}: There are three components:
            \begin{enumerate}
                \item \textbf{A listener object}: You implement one or both listener interfaces (\texttt{GestureDetector.OnGestureListener} (gestures)) (\texttt{GestureDetector.OnDoubleTapListener (taps))}. These contain multiple callback methods.
        ...
        \item \textbf{GestureDetector.OnGestureListener}: An interface that defines six callback methods used to detect general gestures such as:
            ...
            \begin{itemize}
                ...
                \item \textbf{boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY)}: Called when the user drags/moves their finger across the screen slowly.
                    ...
                    \bigbreak \noindent 
                    This continues until the user lifts their finger (ACTION_UP), at which point scrolling stops.
