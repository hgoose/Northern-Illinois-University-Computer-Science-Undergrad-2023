...
\pagebreak 
    ...
    \pagebreak 
    \subsubsection{ImageView.ScaleType (enum)}
    \begin{itemize}
    ...
    \pagebreak \noindent
    \subsubsection{ImageView, ImageView.ScaleType}
    \begin{itemize}
        \item \textbf{Methods}
            \begin{itemize}
        ...
        \item \textbf{With Intents, $A \to B$}:
            \begin{center}
                \begin{tabular}{l|l|l}
                    ...
                    $A$ $\to$ $B$ (startActivity)	onPause() $\to$ (if $B$ covers $A$) $\to$ onStop()	onCreate() $\to$ onStart() $\to$ onResume()\\[2ex]
                    $B$ $\to$ $A$ (Back button)	onRestart() $\to$ onStart() $\to$ onResume()	onPause() $\to$ onStop() $\to$ onDestroy()\\[2ex]
                \end{tabular}
            \end{center}
    \end{itemize}
