    ...
    \begin{itemize}
        ...
        \item \textbf{Public methods}
            \begin{itemize}
                ...
                \item \textbf{float	getRawX()}: Equivalent to getRawX(int) for pointer index 0 (regardless of the pointer identifier).
                ...
                \item \textbf{float	getRawY()}: Equivalent to getRawY(int) for pointer index 0 (regardless of the pointer identifier).
                ...
                \item \textbf{float	getX()}: Equivalent to getX(int) for pointer index 0 (regardless of the pointer identifier).
                \item \textbf{float	getXPrecision()}: Return the precision of the X coordinates being reported.
                \item \textbf{float	getY()}: Equivalent to getY(int) for pointer index 0 (regardless of the pointer identifier).
