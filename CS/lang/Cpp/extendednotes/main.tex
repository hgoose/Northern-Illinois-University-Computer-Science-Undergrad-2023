...
\bigbreak \noindent 
constinit is typically used with static or thread_local variables, as these are the kinds of variables that benefit from compile-time initialization.
\bigbreak \noindent 
...
\begin{itemize}
    ...
    \item \textbf{c++20}: Ranges library, concepts library, modules, coroutines, spaceship operator, std::span, std::format
    \item \textbf{c++23}: 
        \begin{itemize}
