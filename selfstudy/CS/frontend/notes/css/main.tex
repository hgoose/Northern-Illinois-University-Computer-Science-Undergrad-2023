...
.grid-item-3 {
    ...
    \begin{concept}
        \bigbreak \noindent 
        \begin{csscode}
            background-color: rgba(106, 106, 106, 0.5); /* blueish with 50% opacity */
        \end{csscode}
    \end{concept}
    \bigbreak \noindent 
    ...
    \end{csscode}
    \hspace{-.25in}\emp{.a $\sim$ .b} matches the 4th and 5th list item because they: \hspace{.2in}
    \begin{itemize}
        \item Are \emp{.b} elements
        \item Are siblings of \emp{.a}
        \item Appear after \emp{.a} in HTML source order.
    \end{itemize}
