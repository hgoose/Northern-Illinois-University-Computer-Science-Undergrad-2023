...
\begin{document}
    ...
    \nt{It's important to note that lazy matching applies to quantifiers such as *, +, ?, and {}. Without the ? modifier, these quantifiers are greedy by default.
        \\
        Furthermore, the neovim regex engine \textbf{does not} support lazy matching
    }
...
\r
    \end{minted}
    \bigbreak \noindent 
    \nt{Capturing is not necessary here, but it is good convention to capture your matches in the case that you require Backreferencing.}
