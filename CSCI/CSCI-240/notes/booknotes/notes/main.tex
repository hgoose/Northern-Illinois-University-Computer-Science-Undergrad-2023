...
void MyClass::myFunction() {
    ...
    \pagebreak \bigbreak \noindent 
    \section{\LARGE Other Containers}
    \bigbreak \noindent 
    ...
    \pagebreak \bigbreak \noindent 
    \section{\LARGE Variadic Functions in C++ (Ellipsis)}
    \bigbreak \noindent 
    \begin{concept}
...
int main(int argc, const char* argv[]) {
    ...
    \pagebreak \bigbreak \noindent 
    \section{\LARGE std::function<type(args)> <functional>}
    \bigbreak \noindent 
    \begin{concept}
    ...
    \pagebreak \bigbreak \noindent 
    \section{\LARGE Initializer List as function parameters}
    \bigbreak \noindent 

    \bigbreak \noindent 
    \section{\LARGE FINAL KEYWORD (MOVE TO RESPECTIVE PLACE)}
    \bigbreak \noindent 
