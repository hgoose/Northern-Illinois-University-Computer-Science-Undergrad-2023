...
\begin{document}
    ...
    \bigbreak \noindent 
    b.) We aim to show that all points of $n$ are contained entirely within $H$ or $K$, but not spread throughout both. Assume for the sake of contradiction that there exists $X \in H$, $Y \in K$. Then, by theorem 10.6, there exists a point $Z \in m$ such that $ X\text{-}Z\text{-}Y$. Call the line that contains these three collinear points $ \overleftrightarrow{XY}$
    ...
    \begin{mdframed}
        ...
        \begin{enumerate}[label=(\alph*)]
            ...
            \itme $ \overrightarrow{BD}\text{-}\overrightarrow{BC}\text{-}\overrightarrow{BA^{*}} $
        \end{enumerate}
    \end{mdframed}

    \pagebreak \bigbreak \noindent 
    \begin{mdframed}
        5. Given distinct rays $p,q,r,s$ in a pencil $P$ with $ p\text{-}r\text{-}s$, $ps < 180$, $qr = 70 $, answer T/F and explain why in each case
        \begin{enumerate}[label=(\alph*)]
